...
const RESOURCE_MODE_KEYS = {
  ...
  BULK_PDE_APPLICATIONS_MODE: 'bulkPdeApplications',
  BULK_PDE_TEMPLATE_MODE: 'bulkPdeTemplate',
  BULK_PDE_PREVIEW_MODE: 'bulkPdePreview',
  BULK_PDE_REGISTER_MODE: 'bulkPdeRegister',
  BIND_COLUMNS_DATASETS_MODE: 'bindColumnsDatasets',
  BIND_COLUMNS_HARVEST_MODE: 'bindColumnsHarvest',
  BIND_COLUMNS_BDE_OPTIONS_MODE: 'bindColumnsBdeOptions',
  BIND_COLUMNS_PUBLISH_MODE: 'bindColumnsPublish',
  WORKFLOW_BOARD_MODE: 'workflowBoard',
  WORKFLOW_APPROVE_MODE: 'workflowApprove',
